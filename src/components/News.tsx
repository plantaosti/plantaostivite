export function Newsletter() {
  return (
    <>
      <section className="w-full flex-col p-6 lg:p-8 bg-gray-300 md:bg-none">
        <div className="bg-gray-300">
          ...
          <div className="flex flex-col md:flex-row justify-center items-center gap-7 max-w-5xl m-auto">
            <div className="flex flex-col text-white dark:text-gray-600 max-w-sm gap-3">
              <p className="text-sm">
                Você que mora em Santa Terezinha de Itaipu e esta cansado de
                rodar a cidade toda para encontrar a farmácia de planão da
                semana, se liga, aqui você tem todas as informações.
              </p>
              <p className="text-sm">
